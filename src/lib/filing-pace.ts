 ...
 *
 * Goal: file every SC parcel by the end of Tue Jun 30, 2026 — the SC_FILING_FREEZE
...
export const FILING_TARGET_DATE = '2026-06-30';  // finish line (100% by end of this day) = SC freeze
